...
Kirki::add_field( 'cenote_config', array(
	...
	'description' => esc_html__( 'Drag & Drop to re-arrage order of items inside single.', 'cenote' ),
...
Kirki::add_field( 'cenote_config', array(
	...
	'label'       => esc_html__( 'Author Box', 'cenote' ),
	'description' => esc_html__( 'Enable it to display author info box on single post.', 'cenote' ),
	'section'     => 'cenote_section_single',
	'default'     => '1',
) );
...
Kirki::add_field( 'cenote_config', array(
	...
	'label'       => esc_html__( 'Related Posts', 'cenote' ),
	'description' => esc_html__( 'Enable it to display related posts on single post.', 'cenote' ),
	'section'     => 'cenote_section_single',
	'default'     => '1',
) );
