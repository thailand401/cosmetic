...
Kirki::add_field( 'cenote_config', array(
	...
	'description' => esc_html__( 'Choose the layout for the site(wide or boxed).', 'cenote' ),
...
Kirki::add_field( 'cenote_config', array(
	...
	'description' => esc_html__( 'Choose the layout for archive/blog.', 'cenote' ),
	'section'     => 'cenote_section_layout',
...
Kirki::add_field( 'cenote_config', array(
	...
	'description' => esc_html__( 'Choose the layout for Single Post.', 'cenote' ),
	'section'     => 'cenote_section_layout',
...
Kirki::add_field( 'cenote_config', array(
	...
	'description' => esc_html__( 'Choose the layout for page.', 'cenote' ),
	'section'     => 'cenote_section_layout',
	'default'     => 'layout--right-sidebar',
	'choices'     => array(
		'layout--left-sidebar'  => get_template_directory_uri() . '/assets/img/icons/layout--left.jpg',
