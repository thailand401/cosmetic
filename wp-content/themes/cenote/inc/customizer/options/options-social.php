...
Kirki::add_field( 'cenote_config', array(
	...
	'description' => esc_html__( 'Drag & Drop items to re-arrange order of appearance.', 'cenote' ),
	...
	'fields'      => array(
		'social_name'  => array(
			'type'    => 'text',
			'label'   => esc_html__( 'Social Profile Name', 'cenote' ),
			'default' => '',
		),
		'social_url'   => array(
			'type'    => 'text',
		...
		'social_image' => array(
			'type'    => 'image',
			'label'   => esc_html__( 'Custom Image', 'cenote' ),
			'default' => '',
		),
	),
) );
