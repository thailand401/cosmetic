...
Kirki::add_field( 'cenote_config', array(
	...
	'description' => esc_html__( 'Choose the style for footer.', 'cenote' ),
...
Kirki::add_field( 'cenote_config', array(
	...
	'label'       => esc_html__( 'Back to top', 'cenote' ),
	'description' => esc_html__( 'Enable it to display back to top.', 'cenote' ),
	'section'     => 'cenote_section_footer',
	'default'     => '1',
) );
