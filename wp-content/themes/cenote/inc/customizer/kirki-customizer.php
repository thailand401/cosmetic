...
/**
 * Cenote Menu Options section
 */
Kirki::add_section( 'cenote_section_menu', array(
	'title'    => esc_html__( 'Menu', 'cenote' ),
	'panel'    => 'cenote_theme_options',
	'priority' => 20,
) );
...
Kirki::add_section( 'cenote_section_layout', array(
	...
	'description' => esc_html__( 'You can choose layout for pages here. You can also select layout of post and pages individually', 'cenote' ),
	'panel'       => 'cenote_theme_options',
	'priority'    => 25,
) );
...
Kirki::add_section( 'cenote_section_archive', array(
	'title'    => esc_html__( 'Blog/Archive', 'cenote' ),
	'panel'    => 'cenote_theme_options',
	'priority' => 25,
) );
...
// Cenote menu options file goes here.
require get_template_directory() . '/inc/customizer/options/options-menu.php';
