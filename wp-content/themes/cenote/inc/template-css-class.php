...
function cenote_body_classes( $classes ) {
	...
	if ( is_archive() || is_home() ) {
		...
		if ( in_array( get_theme_mod( 'cenote_archive_style', 'tg-archive-style--masonry' ), array( 'tg-archive-style--classic', 'tg-archive-style--big-block' ), true ) && true === get_theme_mod( 'cenote_archive_enable_drop_cap', true ) ) {
			$classes[] = 'archive--drop-cap';
		}
	} elseif ( is_single() ) {
		...
		if ( true === get_theme_mod( 'cenote_single_enable_drop_cap', true ) ) {
			$classes[] = 'single--drop-cap';
		}
	} elseif ( is_page() ) {
...
/**
 * Adds css class to breadcrumb
 */
function cenote_breadcrumb_class() {
	$classes = array();

	$classes[] = get_theme_mod( 'cenote_breadcrumb_style', 'cenote-breadcrumb--light' );
