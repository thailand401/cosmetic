...
$content_orders = get_theme_mod( 'cenote_archive_order_layout', array( 'thumbnail', 'meta', 'title', 'content', 'footer' ) );
			...
			<div class="entry-content">
				<?php
					if ( 'excerpt' === $post_content ) {
						?>
						<p>
							<?php echo esc_html( wp_trim_words( get_the_excerpt(), $excerpt_count, '' ) ); ?>
						</p>
						<?php
